...
import {
  Moon, Sun, Menu, X, LayoutDashboard, Users,
  Bell, AlertTriangle, Building2, LogOut,
...
const navItems = [
  ...
  { path: '/admin/queue',     label: 'Live Queue',      icon: Users },
  { path: '/admin/alerts',    label: 'Alerts',          icon: Bell },
  { path: '/admin/sos',       label: 'SOS Requests',    icon: AlertTriangle },
  { path: '/admin/hospital',  label: 'Hospital Profile', icon: Building2 },
];
        ...
        <div className="flex items-center justify-between px-4 py-5 shrink-0">
          {!collapsed && (
            <div className="flex items-center gap-2">
              <Shield size={20} style={{ color: 'rgb(var(--accent))' }} />
          ...
          {collapsed && (
            <Shield size={24} style={{ color: 'rgb(var(--accent))', margin: '0 auto' }} />
          )}
          <button
        ...
        >
          ...
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg overflow-hidden">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-xs" style={{ color: 'rgb(var(--text-secondary))' }}>Hospital Admin</span>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-screen">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span style={{ color: 'rgb(var(--accent))' }} className="font-black text-xl tracking-tight">
              PRIORI <span className="text-xs font-bold opacity-60">Admin</span>
            </span>
          </div>
